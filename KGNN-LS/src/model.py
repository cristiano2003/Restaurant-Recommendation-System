...
class KGNN_LS(object):
    ...
    def _build_inputs(self):
        self.user_indices = tf.keras.Input(dtype=tf.int64, shape=[None], name='user_indices')
        self.item_indices = tf.keras.Input(dtype=tf.int64, shape=[None], name='item_indices')

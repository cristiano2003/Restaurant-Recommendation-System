...
def get_interaction_table(train_data, n_entity):
    ...
    interaction_table = tf.compat.v1.estimator.lookup.HashTable(
        tf.compat.v1.estimator.lookup.KeyValueTensorInitializer(keys=keys, values=values), default_value=0.5)
